...
var theme = {
    themecolor:[
            ...
            "rgba(237,186,0,0.91)",
            "rgba(250,255,3,0.91)",
            "rgba(240,245,76,0.91)",
            "rgba(246,250,147,0.91)"]}
//交通流量
var data = {
    id: 'multipleBarsLines',
    legendBar: ['2020年同期增长率', '2021年同期增长率'],
    symbol: ' ', //数值是否带百分号        --默认为空 ''
    legendLine: ['环比', '同比'],
    xAxis: ['5周前', '4周前', '3周前', '2周前', '1周前', '本周'],
    yAxis: [
        [8, 10, 10, 11, 4, 13],
        [10, 7, 8, 8, 7, 9]
    ],
    ...
    barColor: theme.themecolor, //柱子颜色 必填参数
    lineColor: theme.themecolor, // 折线颜色
            ...
            itemStyle: {
                normal: {
                    ...
                    borderColor: { 
                        colorStops: [{
                            offset: 0,
                            color: theme.themecolor[0] || theme.themecolor[1] // 0% 处的颜色
                        }, {
                            offset: 1,
                            color: theme.themecolor[1] || theme.themecolor[2] // 100% 处的颜色
                        }]
                    },
                    color: { // 完成的圆环的颜色
                        colorStops: [{
